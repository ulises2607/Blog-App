...
RSpec.describe Post, type: :model do
    it 'is valid with a title, text, and user association' do
      ...
      post = Post.new(title: 'Test Post', text: 'This is a test post', user: user)
    ...
    it 'has five recent comments' do
      user = User.create(name: 'Alice', photo: 'https://unsplash.com/photos/AlicePhoto', bio: 'Bio for Alice')
      post = Post.create(title: 'Test Post', text: 'This is a test post', user: user)
      comment1 = Comment.create(post: post, user: user, text: 'Comment 1')
      comment2 = Comment.create(post: post, user: user, text: 'Comment 2')
      comment3 = Comment.create(post: post, user: user, text: 'Comment 3')
      comment4 = Comment.create(post: post, user: user, text: 'Comment 4')
      comment5 = Comment.create(post: post, user: user, text: 'Comment 5')
      comment6 = Comment.create(post: post, user: user, text: 'Comment 6')
