...
RSpec.describe User, type: :model do
    ...
    it 'returns the last three posts' do
      ...
      post1 = Post.create(user: user, title: 'Post 1', text: 'Content 1', created_at: 1.day.ago)
      post2 = Post.create(user: user, title: 'Post 2', text: 'Content 2', created_at: 2.days.ago)
      post3 = Post.create(user: user, title: 'Post 3', text: 'Content 3', created_at: 3.days.ago)
      post4 = Post.create(user: user, title: 'Post 4', text: 'Content 4', created_at: 4.days.ago)
